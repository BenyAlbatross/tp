...
class DeleteCommandTest {
    ...
    void execute_validIndex_deletesInternship() throws InternityException {
        ...
        DeleteCommand command = new DeleteCommand(internshipList, 1);
    ...
    void execute_indexTooLarge_throwsException() {
        ...
        DeleteCommand command = new DeleteCommand(internshipList, 10);
    ...
    void execute_indexEqualToSize_throwsException() {
        ...
        DeleteCommand command = new DeleteCommand(internshipList, size);
    ...
    void isExit_returnsFalse() {
        ...
        // Arrange
        DeleteCommand command = new DeleteCommand(internshipList, 0);
